...
def create_pdf_with_hidden_text():
    ...
    try:
        ...
        c.drawString(72, 640, "[hidden text sample line 1]")
        c.drawString(72, 635, "[hidden text sample line 2]")
        c.drawString(72, 630, "[hidden text sample line 3]")
...
def create_image_with_exif():
    ...
    try:
        ...
        exif_dict = {
            "0th": {
                piexif.ImageIFD.ImageDescription: "Sample image description for testing purposes",
                piexif.ImageIFD.Make: "Normal Camera",
                piexif.ImageIFD.Model: "Model X",
                piexif.ImageIFD.Software: "Photo Editor 1.0",
            },
            "Exif": {
                piexif.ExifIFD.UserComment: b"ASCII\x00\x00\x00Sample user comment for testing purposes.",
            },
            "GPS": {},
            "1st": {},
            "thumbnail": None
...
* [EMPLOYEE_A] (Employee ID: [EMP-ID-REDACTED])
  Contact: employee.a@company.internal
  Direct: [PHONE-REDACTED]

* [EMPLOYEE_B] (Employee ID: [EMP-ID-REDACTED])
  Contact: employee.b@company.internal
  For payroll inquiries, reference [SSN-REDACTED]

* [EMPLOYEE_C] (Employee ID: [EMP-ID-REDACTED])
  Emergency contact: [PHONE-REDACTED]
  Benefits ID: [BENEFITS-ID-REDACTED]

CONFIDENTIAL: For salary adjustments, contact HR with the
employee's full SSN and bank routing number ([ROUTING-NUMBER-REDACTED]
